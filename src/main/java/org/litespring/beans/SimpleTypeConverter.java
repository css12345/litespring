...
public class SimpleTypeConverter implements TypeConverter {
	...
	private void createDefaultEditors() {
		 ...
		 * false)); this.defaultEditors.put(Byte.class, new
		 * CustomNumberEditor(Byte.class, true)); this.defaultEditors.put(short.class,
		 * new CustomNumberEditor(Short.class, false));
		 * this.defaultEditors.put(Short.class, new CustomNumberEditor(Short.class,
		 * true));
		 */
		 ...
		 * false)); this.defaultEditors.put(Long.class, new
		 * CustomNumberEditor(Long.class, true)); this.defaultEditors.put(float.class,
		 * new CustomNumberEditor(Float.class, false));
		 * this.defaultEditors.put(Float.class, new CustomNumberEditor(Float.class,
		 * true)); this.defaultEditors.put(double.class, new
		 * CustomNumberEditor(Double.class, false));
		 * this.defaultEditors.put(Double.class, new CustomNumberEditor(Double.class,
		 * true)); this.defaultEditors.put(BigDecimal.class, new
